    ...
    left: 25%;">
      ...
      <form role="form" class="contact-form" style="padding-left: 10px;padding-top: 10px;padding-bottom: 10px;padding-right: 10px;" action="submit_details.php" method="POST">
        <div class="form-group col-md-6">
          ...
          <label class="sr-only" for="fname">Enter Name</label>
          <input required=""  name="fname" type="text" class="form-control" id="fname" placeholder="Enter Name" style="width: 170%;height: 38px;">
          <p style="font-size: 20px;font-weight: 600;font-family: 'Open Sans', sans-serif;color: #222222;margin-left:  -130px;">E-mail</p>
          <label class="sr-only" for="mail">Enter E-mail</label>
          <input required="" name="mail" type="text" class="form-control" id="mail" placeholder="Enter E-mail" style="width: 170%;height: 38px;">
          <p style="font-size: 20px;font-weight: 600;font-family: 'Open Sans', sans-serif;color: #222222;margin-left:  -90px;">Contact No</p>
          <label class="sr-only" for="number">Enter Contact No</label>
          <input required=""  name="number" type="text" class="form-control" id="number" placeholder="Enter Contact-No" style="width: 170%;height: 38px;">
          <p style="font-size: 20px;font-weight: 600;font-family: 'Open Sans', sans-serif;color: #222222;margin-left:  -100px;">Username </p>
          <label class="sr-only" for="uname">Enter Username</label>
          <input required="" name="uname" type="text" class="form-control" id="uname" placeholder="Enter Username" style="width: 170%;height: 38px;">
          <p style="font-size: 20px;font-weight: 600;font-family: 'Open Sans', sans-serif;color: #222222;margin-left:  -100px;">Password </p>
          <label class="sr-only" for="pass">Enter Password</label>
          <input required="" name="pass" type="password" class="form-control" id="pass" placeholder="********" style="width: 170%;height: 38px;">
          <p style="font-size: 20px;font-weight: 600;font-family: 'Open Sans', sans-serif;color: #222222;margin-left:  -20px;">Confirm Password</p>
          <label class="sr-only" for="pass1">Enter Password</label>
          <input required="" type="password" class="form-control" id="pass1" placeholder="********" style="width: 170%;height: 38px;">
        </div>
